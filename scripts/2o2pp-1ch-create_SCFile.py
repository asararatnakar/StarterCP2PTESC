...
with open(os.path.join(HOME, 'creds/org1.json'), 'r') as f:
    org1CP = json.load(f)
with open(os.path.join(HOME, 'creds/org2.json'), 'r') as f:
    org2CP = json.load(f)
...
SCtemp['test-network']['gopath'] = 'GOPATH'
...
with open(os.path.join(HOME, 'config-chan1-TLS.json'), 'w') as f:
